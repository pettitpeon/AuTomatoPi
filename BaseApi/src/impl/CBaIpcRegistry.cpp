...
LOCAL void callVoid(const TBaIpcRegFun &rFun, const TBaIpcFunArg &rA) {
   ...
   switch (rFun.type[2]) {
      ...
      default:
         ...
         //
         if (rFun.type.substr(2) == "dII") { ((void(*)(double, int64_t, int64_t))rFun.pFun)(rA.a[0].f, rA.a[1].I, rA.a[2].I); return; }
         if (rFun.type.substr(2) == "dIf") { ((void(*)(double, int64_t, float))  rFun.pFun)(rA.a[0].f, rA.a[1].I, rA.a[2].f); return; }
         if (rFun.type.substr(2) == "dId") { ((void(*)(double, int64_t, double)) rFun.pFun)(rA.a[0].f, rA.a[1].I, rA.a[2].d); return; }

         if (rFun.type.substr(2) == "dfI") { ((void(*)(double, float, int64_t))rFun.pFun)(rA.a[0].f, rA.a[1].f, rA.a[2].I); return; }
         if (rFun.type.substr(2) == "dff") { ((void(*)(double, float, float))  rFun.pFun)(rA.a[0].f, rA.a[1].f, rA.a[2].f); return; }
         if (rFun.type.substr(2) == "dfd") { ((void(*)(double, float, double)) rFun.pFun)(rA.a[0].f, rA.a[1].f, rA.a[2].d); return; }

         if (rFun.type.substr(2) == "ddI") { ((void(*)(double, double, int64_t))rFun.pFun)(rA.a[0].f, rA.a[1].d, rA.a[2].I); return; }
         if (rFun.type.substr(2) == "ddf") { ((void(*)(double, double, float))  rFun.pFun)(rA.a[0].f, rA.a[1].d, rA.a[2].f); return; }
         if (rFun.type.substr(2) == "ddd") { ((void(*)(double, double, double)) rFun.pFun)(rA.a[0].f, rA.a[1].d, rA.a[2].d); return; }
         break;
   }
}
