...
\subsubsection[{\texorpdfstring{Get\+Directory(std\+::string path, char delimiter= \textquotesingle{}/\textquotesingle{})}{GetDirectory(std::string path, char delimiter= '/')}}]{\setlength{\rightskip}{0pt plus 5cm}static std\+::string Ba\+Path\+::\+Get\+Directory (
\begin{DoxyParamCaption}
\item[{std\+::string}]{path, }
\item[{char}]{delimiter = {\ttfamily \textquotesingle{}/\textquotesingle{}}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}\hypertarget{namespaceBaPath_aee6b101395e5f32a76b304aa765de13c}{}\label{namespaceBaPath_aee6b101395e5f32a76b304aa765de13c}
...
\subsubsection[{\texorpdfstring{Get\+Filename(std\+::string path, char delimiter= \textquotesingle{}/\textquotesingle{})}{GetFilename(std::string path, char delimiter= '/')}}]{\setlength{\rightskip}{0pt plus 5cm}static std\+::string Ba\+Path\+::\+Get\+Filename (
\begin{DoxyParamCaption}
\item[{std\+::string}]{path, }
\item[{char}]{delimiter = {\ttfamily \textquotesingle{}/\textquotesingle{}}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}\hypertarget{namespaceBaPath_a41d87786f4a43d64094624187ac90dca}{}\label{namespaceBaPath_a41d87786f4a43d64094624187ac90dca}
...
Referenced by Ba\+Core\+Get\+Own\+Name(), Change\+File\+Extension(), and Get\+File\+Extension().

\index{Ba\+Path@{Ba\+Path}!Get\+File\+Extension@{Get\+File\+Extension}}
\index{Get\+File\+Extension@{Get\+File\+Extension}!Ba\+Path@{Ba\+Path}}
\subsubsection[{\texorpdfstring{Get\+File\+Extension(std\+::string path, char delimiter= \textquotesingle{}/\textquotesingle{})}{GetFileExtension(std::string path, char delimiter= '/')}}]{\setlength{\rightskip}{0pt plus 5cm}static std\+::string Ba\+Path\+::\+Get\+File\+Extension (
\begin{DoxyParamCaption}
\item[{std\+::string}]{path, }
\item[{char}]{delimiter = {\ttfamily \textquotesingle{}/\textquotesingle{}}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}\hypertarget{namespaceBaPath_a42b3acac9c048e45a531c9dc4be319f1}{}\label{namespaceBaPath_a42b3acac9c048e45a531c9dc4be319f1}
...
\subsubsection[{\texorpdfstring{Change\+File\+Extension(std\+::string path, std\+::string ext, char delimiter= \textquotesingle{}/\textquotesingle{})}{ChangeFileExtension(std::string path, std::string ext, char delimiter= '/')}}]{\setlength{\rightskip}{0pt plus 5cm}static std\+::string Ba\+Path\+::\+Change\+File\+Extension (
\begin{DoxyParamCaption}
\item[{std\+::string}]{path, }
\item[{std\+::string}]{ext, }
\item[{char}]{delimiter = {\ttfamily \textquotesingle{}/\textquotesingle{}}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}\hypertarget{namespaceBaPath_a70f965f0c97d211e1f91dc2f16e05195}{}\label{namespaceBaPath_a70f965f0c97d211e1f91dc2f16e05195}
...
\item \char`\"{}/foo/bar/baz.\+txt\char`\"{}, \char`\"{}\char`\"{} --$>$ \char`\"{}/foo/bar/baz\char`\"{}A
