...
\hypertarget{namespaceBaFS_a500756f66ff45aaf311421e7f68a0070}{}\index{Ba\+F\+S@{Ba\+F\+S}!Cp\+File@{Cp\+File}}
\index{Cp\+File@{Cp\+File}!Ba\+F\+S@{Ba\+F\+S}}
\subsubsection[{Cp\+File(std\+::string src, std\+::string dst)}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf T\+Ba\+Bool\+R\+C} Ba\+F\+S\+::\+Cp\+File (
\begin{DoxyParamCaption}
\item[{std\+::string}]{src, }
\item[{std\+::string}]{dst}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}\label{namespaceBaFS_a500756f66ff45aaf311421e7f68a0070}
