...
src/%.o: ../src/%.cpp
	...
	arm-linux-gnueabihf-g++ -std=c++0x -I"D:\Programming\Repos\rpiapi\cppunit-1.12.1\include" -I"D:\Programming\Repos\rpiapi\cppunit-1.12.1\include\cppunit" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
